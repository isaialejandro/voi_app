...
class Applicant(models.Model):
    ...
    id_puesto = models.CharField(max_length=200, null=True)
    id_area_chief = models.CharField(max_length=200, null=True)
    id_area_dir = models.CharField(max_length=200, null=True)
    id_area_ger = models.CharField(max_length=200, null=True)
    id_area_jef = models.CharField(max_length=200, null=True)

    email = models.EmailField(default='', null=True)
    no_ambassador_boss = models.CharField(max_length=20, null=True)
    id_ambassador_status = models.CharField(max_length=4, null=True)
    id_station = models.CharField(max_length=4, null=True)
    genere = models.CharField(max_length=200, null=True)
    ...
    applicant_reg_date = models.CharField(max_length=10, null=True, blank=True) #default with applicant manual list load.
